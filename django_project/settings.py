...
INSTALLED_APPS = [
    ...
    "bootstrap5",
    "accounts",  # for accounts, login/logout
    "timely",
]
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "templates"],  # for using project level templates, also see L4
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
LOGIN_REDIRECT_URL = "home"  # where login/logout should redirect
